...
export function AnimatedModalDemo() {
  ...
  return (
    <div className="flex items-center justify-center">
      <Modal>
        <ModalTrigger className="bg-primary text-primary-foreground hover:bg-primary/90 flex justify-center group/modal-btn">
        ...
        <ModalBody>
          <ModalContent>
            <h4 className="text-lg md:text-2xl font-bold text-center mb-8">
              Book your trip to{" "}
              <span className="px-1 py-0.5 rounded-md bg-muted">
                Bali
              </span>{" "}
              now! 📥
            </h4>
            <div className="flex justify-center items-center">
              {images.map((image, idx) => (
                <motion.div
                  ...
                  className="rounded-xl -mr-4 mt-4 p-1 bg-card border-border flex-shrink-0 overflow-hidden"
                >
                  <Image
                    src={image}
                    alt="bali images"
